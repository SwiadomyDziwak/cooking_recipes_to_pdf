...
def add_tag(*, ui: dict[str, Option], last_options: dict[str, Option], tui: TUI, recipe: Recipe, **kwargs) -> tuple[dict[str, Option], list[tuple[str, str]]|None]:
...
def remove_tag(*, ui: dict[str, Option], last_options: dict[str, Option], tui: TUI, recipe: Recipe, **kwargs) -> tuple[dict[str, Option], list[tuple[str, str]]|None]:
...
def categories_menu(*, ui: dict[str, str], last_options: dict[str, Option], tui: TUI, recipe: Recipe, **kwargs) -> tuple[dict[str, Option], list[tuple[str, str]]|None]:
    ...
    for category in recipe.ingredients.keys():
        options[str(category_counter)] = Option(category, select_category)
        category_counter += 1
